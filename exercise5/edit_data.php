...
if(isset($_POST['btn-update']))
{
 ...
 $sql_query = "UPDATE users SET complete_name='$complete_name',nickname='$nickname',email='$email',address='$address' ,gender='$gender',number='$cellno',comment='$comment' WHERE user_id=".$_GET['edit_id'];
 // sql query for update data into database
...
<div id="body">
 <div id="content">
    ...
    <tr>
    <td>
    <button type="submit" name="btn-update" style="color:white;"><strong>UPDATE</strong></button>
    </td>
    </tr>
    </table>
    </form>
