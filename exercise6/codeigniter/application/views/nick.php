...
#fb {position:absolute;margin-left:900px;margin-top:635px;}
#twitter {position:absolute;margin-left:940px;margin-top:635px;}
#insta {position:absolute;margin-left:980px;margin-top:635px;}

.ts2 {position:absolute;margin-top:582px;background-color:brown;width:1250px;height:60px;z-index:-1;}
</style>
</head>
...
<div class="ts2"> </div>
 ...
 <a href="https://www.facebook.com/kevsbarrion06" ><img src="http://localhost/exercise6/codeigniter/pics/fb.png" width="30px" height="30px" alt="fb" style="float:right;" id="fb"> </a>
  <a href="https://twitter.com/"><img src="http://localhost/exercise6/codeigniter/pics/twitter.png" width="30px" height="30px" alt="fb" style="float:right;" id="twitter"></a>
   <a href="https://www.instagram.com/"> <img src="http://localhost/exercise6/codeigniter/pics/insta.png" width="30px" height="30px" alt="fb" style="float:right;" id="insta"></a>
...
<img src="http://localhost/exercise6/codeigniter/pics/b.jpg" align="left" style="width:320px;height:55%;margin:0px;"> <p style="text-align:left;color:black;font-size:40px;margin:4;"> 

<div class="move" style="margin-left: 320px;">
<right><table style="width:900px;background-color:black;">
<tr>
<th class="heading"style="font-size:80px;text-align:left;font-family:Eras Bold ITC;"> Nickname :</th>
</tr>
<tr>
<td class="data" style="font-size:70px;font-family:Eras Bold ITC;"> "Kevs"  </td>
</tr>
</table></right>
</div>
<br>
<hr><p id="4">
<center>Know More ABOUT ME? <br>
Add me on Facebook : <a id="color" href="https://www.facebook.com/kevsbarrion06" target="_blank" > https://www.facebook.com/kevsbarrion06  
<hr></p>
